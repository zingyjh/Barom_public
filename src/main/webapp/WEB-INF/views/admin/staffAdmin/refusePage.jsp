        ...
        <div class="row mt-4">
            ...
            <div class="col contentArea">
                ...
                <div class="row mt-1 conTitleArea">
                    <h3 class="conTItle"><i class="bi bi-list"></i> 보정명령</h3>
                </div>
                ...
                <div class="col ps-5" style="">
                    ...
                    <form action="./caseRefuseProcess" method="post">
                        ...
                        <div class="row mt-5 formTable">
                            <div class="row formTitleArea">
                                <div class="col formTitle"><span><i class="bi bi-clipboard-fill"></i> 보정 명령 사유</span>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1 divBorder">
                            <div class="col-2 inputTitle">보정 명령 사유</div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-1 text-end mb-5">
                                <button type="submit" class="btnBasic inputSubmit bi bi-check2-square"> 등록</button>
                            </div>
                        </div>

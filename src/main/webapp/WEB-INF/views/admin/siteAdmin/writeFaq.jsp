    ...
    <section class="container-fluid">
        ...
        <div class="row mt-4">
            ...
            <div class="col contentArea">
				...
				<form action="./writeFaqProcess" method="post">
					<table class="table caption-top">
						<tbody>
							<tr>
								<th scope="row">구분</th>
								<td>
									<select name="faq_category_no" class="form-select form-select-sm" aria-label=".form-select-sm example" style="width:200px;">
										<option selected disabled hidden> 질문 종류 선택 </option>
										<c:forEach items="${FAQ_CategoryList }" var="faqCategory">
										<option value="${faqCategory.faq_category_no }"><c:out value="${faqCategory.faq_category_name }"/></option>
										</c:forEach>
									</select>
								</td>
							</tr>
							<tr>
								<th scope="row">제목</th>
								<td>
									<input type="text" name="faq_title" style="width:740px;'">
								</td>
							</tr>
							<tr>
								<th scope="row">내용</th>
								<td>
									<textarea name="faq_content" rows="20" cols="100"></textarea>
								</td>
							</tr>
						</tbody>
					</table>					

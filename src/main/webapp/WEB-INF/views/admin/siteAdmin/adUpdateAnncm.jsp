        ...
        <div class="row mt-4">
            ...
            <div class="col contentArea">
                ...
                <div class="row mt-1 conTitleArea">
                    <h3 class="conTItle"><i class="bi bi-list"></i> 공지사항 수정하기</h3>
                </div>
                ...
                <div class="row mt-5 ms-4 me-4">
                    <div class="col">
                        ...
                        <form action="./updateAnncmProcess" method="post" enctype="multipart/form-data">

                            <input type="hidden" name="admin_no" value="${AnncmData.announcementVo.admin_no }">
                            <input type="hidden" name="anncm_no" value="${AnncmData.announcementVo.anncm_no }">

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">제 목</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="anncm_title"
                                    value="${AnncmData.announcementVo.anncm_title }">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">내 용</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                    name="anncm_content">${AnncmData.announcementVo.anncm_content }</textarea>
                            </div>

                            <!--  <div class="mb-3">
							  <label for="formFileMultiple" class="form-label">파일 첨부</label>
							  <input class="form-control" type="file" id="formFileMultiple" multiple name="uploadFiles"> 
						</div> -->


                            <button type="submit" class="btn text-white" style="background-color:#C65D7B;">수정완료</button>
                        </form>

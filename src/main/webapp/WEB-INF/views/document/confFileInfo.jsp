...
<head>
    ...
    <script type="text/javascript" src="../resources/js/document/confFileInfo.js"></script>
        ...
        <div class="row mt-4">
            ...
            <div class="col">
                ...
                <div class="row mt-1 conTitleArea">
                    <h3 class="conTItle"><i class="bi bi-list"></i> 증빙서류</h3>
                </div>

                <!-- 
                <div class="row" id="inputFiles"></div>
					<div class="col">
                ...
                <div class="row formTable">
                    ...
                    <form action="confFileInfoProcess" method="post" enctype="multipart/form-data"
                        name="uploadFilesForm">
                        <div class="row formTitleArea">
                            <div class="col formTitle"><span><i class="bi bi-clipboard-fill"></i> 파일 첨부하기</span></div>
                        </div>
                        <div class="row divBorder">
                            ...
                            <div class="col-1">
                                <div class="btnBasic addBtn" onclick="addFiles();"> + </div>
                            </div>
                        </div>
                        <div class="row divBorder" id="inputFiles">
                ...
                <div class="row formEndBorder">
                    <div class="col-2 text-center">
                        <a href="./modPetition?case_no=<c:if test=" ${case_code !=null }">${case_code }</c:if>"
                            class="btnDirection btn"><i class="bi bi-arrow-left-circle-fill"></i> 이전</a>
                    </div>
                    <div class="col"></div>
                    <div class="col-2 text-center">
                        <a href="./preShowPdf" class="btnDirection btn">다음 <i

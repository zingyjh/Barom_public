...
<head>
  ...
  <script type="text/javascript" src="../resources/js/document/petition.js"></script>
    ...
    <div class="row mt-4">
      ...
      <div class="col">
        ...
        <div class="row mt-1 conTitleArea">
          <h3 class="conTItle"><i class="bi bi-list"></i> 소장 정보 작성</h3>
        </div>

        <!-- 페이지별 내용 시작-->
        <input type="hidden" id="case_code" value="${case_code }">
        <jsp:include page="./petition_process/caseBasicInfo.jsp"></jsp:include>
        <jsp:include page="./petition_process/concernedInfo.jsp"></jsp:include>
        <jsp:include page="./petition_process/purposeInfo.jsp"></jsp:include>
        <jsp:include page="./petition_process/causeInfo.jsp"></jsp:include>

        <div class="row formEndBorder mt-3">
          <div class="col-2 text-center">
            <a href="../user/submitListPage" class="btn btnGray">사건 목록으로</a>
          </div>
          <div class="col"></div>
          <div class="col-2 text-center">
            <div class="btnDirection btn" onclick="toNextPage();">다음 <i class="bi bi-arrow-right-circle-fill"></i></div>
          </div>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button onclick="closeNoticeModal()" type="button" class="btn btnBasic">확인</button>
              </div>
            </div>
          </div>
        </div>

        ...
        <div class="row mt-4">
            ...
            <div class="col">
                ...
                <div class="row mt-1 conTitleArea">
                    <h3 class="conTItle"><i class="bi bi-list"></i> 소장 제출 완료</h3>
                </div>

                <div class="row text-center mt-2">
                    <div class="img-fluid">
                        <img src="../resources/img/file_2.png" alt="" style="width: 18%;">
                    </div>
                </div>
                <div class="row text-center mt-5">
                    <h1>소장 제출이 완료되었습니다.</h1>
                </div>
                
                <div class="row mt-3">
                    <div class="col-2"></div>
                    <div class="col d-grid">
                        <a href="http://barom.s001lec.com:8080/" class="btn btnBasic">메인페이지로</a>
                    </div>
                    <div class="col-2"></div>
                    <div class="col d-grid">
                        <a href="../user/submitListPage" class="btn btnGray">소장목록으로</a>
                    </div>
                    <div class="col-2"></div>
                </div>

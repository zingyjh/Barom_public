                ...
                <div class="row mt-3">
                    <div class="col">
                        <form action="./updateContentProcess" method="post">
                            작성자 : ${data.userVo.user_name }<br>
                            제목 : <input type="text" class="form-control" value="${data.questionVo.cus_question_title }"
                                name="cus_question_title"><br>
                            내용 : <br>
                            <textarea class="form-control" rows="10" cols="40"
                                name="cus_question_content">${data.questionVo.cus_question_content }</textarea>
                            <br>
                            <input type="hidden" name="cus_question_no" value="${data.questionVo.cus_question_no }">

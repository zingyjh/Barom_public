        ...
        <div class="row mt-4">
            ...
            <div class="col">
                ...
                <div class="row mt-1 conTitleArea">
                    <h3 class="conTItle"><i class="bi bi-list"></i> 제출 완료</h3>
                </div>

                <!-- 페이지별 내용 시작-->
                <div class="row mt-5">
                	<div class="col text-center fs-1">
						<i class="bi bi-file-earmark-check-fill"></i> 제출이 완료되었습니다.
					</div>
				</div>
				<div class="row mt-4">
					<div class="col"></div>
					<div class="col-2 d-grid">
						<a href="http://barom.s001lec.com:8080/" class="btnBasic">메인페이지로</a>
					</div>
					<div class="col-2 d-grid">
						<a href="../user/myCasePage" class="btnGray">사건목록으로</a>
					</div>
					<div class="col"></div>
				</div>
